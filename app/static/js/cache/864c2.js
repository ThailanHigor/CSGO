...
})(
    {
        ...
        8: [
            function (e, t, n) {
                ...
                var i = function e(t, n, o) {
                    ...
                    var s = function (t, e) {
                            if ("https:" === F.default.location.protocol && 0 === t.indexOf("index.html") && R.IS_IOS && -1 < j.default.html5media.mediaTypes.indexOf(e)) {
            ...
            function (e, t, n) {
                ...
                var k = {
                        ...
                        getYouTubeId: function (e) {
                            var t = "";
                            return (
                                0 < e.indexOf("?") ? "" === (t = k.getYouTubeIdFromParam(e)) && (t = k.getYouTubeIdFromUrl(e)) : (t = k.getYouTubeIdFromUrl(e)),
                                (t = t.substring(t.lastIndexOf("https://overworld.qodeinteractive.com/") + 1).split("?"))[0]
                            );
                        },
                        ...
                        getYouTubeIdFromUrl: function (e) {
                            return null != e && e.trim().length ? (e = e.split("?")[0]).substring(e.lastIndexOf("https://overworld.qodeinteractive.com/") + 1) : null;
                        },
                        getYouTubeNoCookieUrl: function (e) {
                            if (null == e || !e.trim().length || -1 === e.indexOf("//www.youtube")) return e;
                            var t = e.split("https://overworld.qodeinteractive.com/");
                            return (t[2] = t[2].replace(".com", "-nocookie.com")), t.join("https://overworld.qodeinteractive.com/");
                        },
                    },
                    s = {
                        name: "youtube_iframe",
        ...
        30: [
            function (e, t, n) {
                ...
                function f(e) {
                    if ("string" != typeof e) throw new Error("`url` argument must be a string");
                    var t = e.split("?")[0].split("\\").pop().split("https://overworld.qodeinteractive.com/").pop();
...
!(function (e, a) {
    void 0 === mejs.plugins && ((mejs.plugins = {}), (mejs.plugins.silverlight = []), mejs.plugins.silverlight.push({ types: [] })),
        (mejs.HtmlMediaElementShim = mejs.HtmlMediaElementShim || { getTypeFromFile: mejs.Utils.getTypeFromFile }),
